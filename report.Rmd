...
This project investigates the key structural and locational factors influencing residential property prices in Ames, Iowa. We hypothesize that living area, material quality, and neighborhood are the strongest predictors of sale price. Using exploratory data analysis and regression modeling, we aim to identify which features most significantly contribute to housing market value.
